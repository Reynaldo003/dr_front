  ...
  return (
    <div className="fixed bottom-5 right-4 z-[70] flex flex-col gap-3 sm:bottom-6 sm:right-6">
      ...
      <a
        ...
        className="group flex h-12 w-12 items-center justify-center rounded-full border border-black/10 bg-white shadow-lg transition duration-300 hover:-translate-y-1 hover:shadow-xl"
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="h-7 w-7 fill-black transition group-hover:scale-110"
        >
      ...
      >
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          className="h-6 w-6 fill-black transition group-hover:scale-110"
        >
